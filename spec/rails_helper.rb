...
RSpec.configure do |config|
  ...
  # It makes it use the chrome browser, but can also beconfigured to user Firefox, etc. 
  Capybara.register_driver :selenium do |app|
    # profile = Selenium::WebDriver::Firefox::Profile.new # TODO: Remove if not needed for hover
